     ...
     <div id="caixa">
            ...
            <div id="cima">
               ...
               <div id="cimadir">
                    ...
                    <div id="cimadiresq">
                         ...
                         <table id="tb1">
                              <tr><td id="texto">Atend.:</td><td id="inp"><input id="campo2" class="form-control form-control-sm" readonly="true" type="text" placeholder="Código do atendimento"></td></tr>
                    ...
                    <div id="cimadirdir">
                         ...
                         <table id="tb2">
                              ...
                              <tr><td id="l2tb2"><button type="button" class="btn btn-dark btn-lg btn-block">Histórico do Paciente</button></td></tr>
                              <tr><td id="l2tb2"><button type="button" class="btn btn-dark btn-lg btn-block">Cadastro completo</button></td></tr>
            ...
            <div id="abas">            
                ...
                <div class="btn-group btn-group-toggle" id="tamanhoaba" data-toggle="buttons">
                    <label class="btn btn-info" onclick="muda('1')" id="option1">
                        <input type="radio" name="options" autocomplete="off"> Odontograma
                    </label>
                    <label class="btn btn-info active" onclick="muda('2')" id="option1">
                        <input type="radio" name="options" autocomplete="off" checked> Anaminese
                    </label>
                    <label class="btn btn-info" onclick="muda('3')" id="option1">
                        <input type="radio" name="options" autocomplete="off"> Anexos
                    </label>
                    <label class="btn btn-info" id="option1">
                        <input type="radio" name="options" autocomplete="off"> Receituário
                    </label>
                </div>
